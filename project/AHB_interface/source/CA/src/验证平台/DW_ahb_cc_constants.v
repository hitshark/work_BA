...
// DefaultValue: 32
// EnumValues:   8 16 32 64 128 256
`define AHB_DATA_WIDTH 32


// Description:  Selects the max width of the read back register in the arbiter 
//               interface.
// DefaultValue: 32
// EnumValues:   8 16 32
...
//                
//               It is not possible to instaniate the weighted token priority 
...
// Description:  If True (1), the decoder supplies hsels to the DW_ahb for rerouting 
...
// Description:  If there are no split capable slaves in the system then there is no need to support splits. 
...
// DefaultValue: 0x3230322a
// MinValue:     0x0
// MaxValue:     0xffffffff
`define AHB_VERSION_ID 32'h3230322a
